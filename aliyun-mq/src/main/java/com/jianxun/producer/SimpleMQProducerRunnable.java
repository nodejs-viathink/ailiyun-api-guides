...
public class SimpleMQProducerRunnable implements Runnable{
    ...
    public void run() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            String orderId = this.producerId + "--" + i + "--" + Math.random();
            ...
            try {
                ...
                System.out.println(new Date() + " Send mq message success! Topic is:" + this.topic + ", tag is: " + this.tag + ", msgKey is: " + message.getKey());
